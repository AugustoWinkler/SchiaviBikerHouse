    ...
    <>
        <div  id="scrollService" className="service">
            ...
            <div id="backgrounddeco">
                <img src="public/assets/sbhlogoblack.png" alt="Logo Schiavi Biker House" />
            </div>
            <div className="containers">
                <Container url = 'public/assets/Manutencao.png'/>
                <Container url = 'public/assets/Suspensao.png'/>
                <Container url = 'public/assets/Dinamometro.png'/>
            </div>
        </div>
    </>
    )
