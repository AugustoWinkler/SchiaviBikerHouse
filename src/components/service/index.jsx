    ...
    <>
        <div  id="scrollService" className="service">
            ...
            <div id="backgrounddeco">
                <img src="src/assets/sbhlogoblack.png" alt="Logo Schiavi Biker House" />
            </div>
            <div className="containers">
                <Container url = 'src/assets/Manutencao.png'/>
                <Container url = 'src/assets/Suspensao.png'/>
                <Container url = 'src/assets/Dinamometro.png'/>
            </div>
        </div>
    </>
    )
